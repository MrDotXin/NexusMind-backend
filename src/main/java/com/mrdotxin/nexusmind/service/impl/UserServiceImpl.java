...
import com.mrdotxin.nexusmind.mapper.mysql.UserMapper;
import com.mrdotxin.nexusmind.model.dto.user.UserQueryRequest;
...
import static com.mrdotxin.nexusmind.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    @Override
    public String uploadUserAvatar(String policy, Object source, User user) {
        String avatar = fileManager.uploadFileRaw(policy, source, FileConstant.UPLOAD_FILE_PATH + "/user", 10 * 1024 * 1024L);

        String oldPic = user.getUserAvatar();

        boolean update = this.lambdaUpdate()
                .eq(User::getId, user.getId())
                .set(User::getUserAvatar, avatar)
                .update();
